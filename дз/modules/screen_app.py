...
class App(ctk.CTk):
    def __init__(self,app_width,app_height):
        ...
        self.FRAME1 = m_frame.My_Frame(text= "Friendly Chat", master = self, width= 130, height= app_height - 20, border_width= 5)
        self.FRAME = ctk.CTkFrame(master=self, width=300, height= app_height)
        self.FRAME2 = m_frame.My_Frame(text = "chats", master = self, width= 130, height= app_height - 20, border_width= 5)
        ...
        #self.FRAME2 = m_frame.My_Frame(text= "contacts" ,master = self, width= 130, height= app_height - 20, border_width= 5)
        #self.FRAME = ctk.CTkFrame(master=self, width=300, height= app_height)
        #
        #self.FRAME.grid(row = 0, column = 0, padx = 0, pady = 10)
